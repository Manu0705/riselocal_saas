    ...
    <div style={{ padding: 16, color: "var(--text)" }}>
      ...
      {!loading && !error ? (
        <>
          ...
          >
            <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
              <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Total Followups</p>
              <p style={{ margin: "4px 0 0", color: "#22c55e", fontSize: 18, fontWeight: 700 }}>{metrics.followUpLeads}</p>
            </div>
            <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
              <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Today</p>
              <p style={{ margin: "4px 0 0", color: "#2563eb", fontSize: 18, fontWeight: 700 }}>{metrics.followUpsToday}</p>
            </div>
            <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
              <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Overdue</p>
              <p style={{ margin: "4px 0 0", color: "#f59e0b", fontSize: 18, fontWeight: 700 }}>{metrics.followUpsOverdue}</p>
            </div>
            <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
              <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Unscheduled</p>
              <p style={{ margin: "4px 0 0", color: "#10b981", fontSize: 18, fontWeight: 700 }}>{metrics.followUpsUnscheduled}</p>
            </div>
          </div>
