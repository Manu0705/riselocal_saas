  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16, overflowX: "auto" }}>
        {categories.map((cat) => (
          <button
            ...
            style={{
              flex: "0 0 auto",
              border: selectedCategory === cat ? "2px solid #3b82f6" : "1px solid var(--card-border)",
      ...
      >
        {uploading ? (
          <>
            <Loader2 size={24} strokeWidth={2} style={{ animation: "spin 1s linear infinite", marginBottom: 8 }} />
