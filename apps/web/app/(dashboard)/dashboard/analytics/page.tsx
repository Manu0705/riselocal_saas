    ...
    <div style={{ padding: 16, color: "var(--text)" }}>
      ...
      >
        <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
          ...
          <p style={{ margin: "4px 0 0", color: "#22c55e", fontWeight: 700, fontSize: 18 }}>{metrics.totalLeads}</p>
        </div>
        <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
          <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Conversion Rate</p>
          <p style={{ margin: "4px 0 0", color: "#2563eb", fontWeight: 700, fontSize: 18 }}>{metrics.conversionRate}%</p>
        </div>
        <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
          <p style={{ margin: 0, color: "var(--muted)", fontSize: 12 }}>Converted</p>
          <p style={{ margin: "4px 0 0", color: "#f59e0b", fontWeight: 700, fontSize: 18 }}>{metrics.convertedLeads}</p>
        </div>
        <div style={{ border: "1px solid var(--card-border)", borderRadius: 10, padding: 10, background: "var(--card)" }}>
